...
$original_string="qwertyuiopasdfghjklzxcvbnm1234567890MNBVCXZLKJHGFDSAPOIUYTREWQ";
$ret_string=substr(str_shuffle("$original_string"),26,15);
echo "<br>".$ret_string;

$extra_chr='\"1+2/3*2:2-3/4*3/7*2';
echo "<br>".str_replace(str_split('\"+*:-/'),'',$extra_chr);
